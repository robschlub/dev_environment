    ...
    this.addSection({
      ...
      setContent: `
        <table class="lesson__important_angles_table">
          <tr>
            <td class="lesson__important_angles_table_selected">|Acute|</td>
            <td>|Right|</td>
            <td>|Obtuse|</td>
            <td>|Straight|</td>
            <td>|Reflex|</td>
      ...
      `,
      modifiers: {
        Acute: click(diag.goToAcute, [diag]),
        Right: click(diag.goToRight, [diag]),
        Obtuse: click(diag.goToObtuse, [diag]),
        Straight: click(diag.goToStraight, [diag]),
        Reflex: click(diag.goToReflex, [diag]),
      },
      setEnterState: () => {
