...
Point.prototype.isEqualTo = function isEqualTo(q: Point, precision?: number) {
  let pr = this;
  let qr = q;
  if (precision) {
...
/* eslint-disable */
// Point.prototype.isNotEqualTo = function isNotEqualTo(q, precision=undefined) {
//   return !this.isEqualTo(q, precision);
// }
// Point.prototype.isOnLine = function isOnLine(l, precision) {
//   return l.hasPointOn(this, precision);
// }
// Point.prototype.isOnUnboundLine = function isOnUnboundLine(l, precision) {
//   return l.hasPointAlong(this, precision);
// }
// Point.prototype.console = function console(text) {
...
//     - (p2.x -  p0.x) * (p1.y - p0.y) );
// }
// Point.prototype.isInPolygon = function isInPolygon(polygonVertices) {
//   let windingNumber = 0;
...
//   return true;
// }
// Point.prototype.isOnPolygon = function isOnPolygon(polygonVertices) {
//   let popLastPoint = false;
//   let p=this;
